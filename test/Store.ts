...
import DessertFactory from "./factories/DessertFactory"
import NetworkFactory from "./factories/NetworkFactory"

type dataDessert ={id:number,name:string,image:string, price:number,stock:number,category:string,description: string[]}
type dataNetwork ={id:number,name:string,image:string};
